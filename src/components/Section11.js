...
const Section11 = () => {
  return (
    <footer className="bg-[#211b36]  pt-4 lg:pb-0 px-[10%]">
      <div className="container flex flex-col items-center lg:flex-row lg:justify-between">
        <p className="text-xs mb-4 lg:mb-0  text-center lg:text-left text-gray-400">
          Copyright{" "}
          <span
            style={{
        ...
        {/* Social Media Icons */}
        <div className="flex space-x-4 lg:pb-3 text-white">
          <a
